...
-- led_STBY	=>  Location: PIN_164,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- code_fonction[0]	=>  Location: PIN_168,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- code_fonction[1]	=>  Location: PIN_160,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- code_fonction[2]	=>  Location: PIN_171,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- BP_Tribord	=>  Location: PIN_185,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- BP_Barbord	=>  Location: PIN_159,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \udiv1hz|process_0~1_combout\ = (\udiv1hz|cpt1\(16)) # (((\udiv1hz|cpt1\(18)) # (!\udiv1hz|cpt1\(17))) # (!\udiv1hz|cpt1\(15)))
...
-- pragma translate_on
PORT MAP (
	dataa => \udiv1hz|cpt1\(16),
	datab => \udiv1hz|cpt1\(15),
	datac => \udiv1hz|cpt1\(17),
...
-- Equation(s):
-- \udiv1hz|process_0~2_combout\ = (((\udiv1hz|process_0~1_combout\) # (\udiv1hz|cpt1\(24))) # (!\udiv1hz|cpt1\(25))) # (!\udiv1hz|cpt1\(23))
...
-- Equation(s):
-- \udiv1hz|process_0~3_combout\ = (!\udiv1hz|cpt1\(2) & (!\udiv1hz|cpt1\(0) & (!\udiv1hz|cpt1\(1) & !\udiv1hz|cpt1\(3))))
...
-- pragma translate_on
PORT MAP (
	dataa => \udiv1hz|cpt1\(2),
	datab => \udiv1hz|cpt1\(0),
	datac => \udiv1hz|cpt1\(1),
	datad => \udiv1hz|cpt1\(3),
...
-- Equation(s):
-- \udiv1hz|process_0~4_combout\ = (!\udiv1hz|cpt1\(5) & (!\udiv1hz|cpt1\(4) & (!\udiv1hz|cpt1\(9) & !\udiv1hz|cpt1\(8))))
...
-- Equation(s):
-- \udiv1hz|process_0~5_combout\ = (\udiv1hz|cpt1\(13) & (\udiv1hz|cpt1\(12) & (!\udiv1hz|cpt1\(10) & \udiv1hz|cpt1\(14))))
...
-- Equation(s):
-- \udiv1hz|process_0~6_combout\ = (\udiv1hz|cpt1\(20) & (\udiv1hz|cpt1\(19) & (\udiv1hz|cpt1\(22) & \udiv1hz|cpt1\(21))))
...
-- Equation(s):
-- \udiv1hz|process_0~8_combout\ = (!\udiv1hz|cpt1\(28) & (!\udiv1hz|cpt1\(29) & (!\udiv1hz|cpt1\(27) & !\udiv1hz|cpt1\(26))))
...
-- Equation(s):
-- \udiv1hz|process_0~9_combout\ = (!\udiv1hz|cpt1\(31) & (!\udiv1hz|cpt1\(30) & \udiv1hz|process_0~8_combout\))
...
-- Equation(s):
-- \udiv1hz|process_0~10_combout\ = (\udiv1hz|process_0~2_combout\) # (((\udiv1hz|process_0~0_combout\) # (!\udiv1hz|process_0~7_combout\)) # (!\udiv1hz|process_0~9_combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \udiv1hz|process_0~2_combout\,
	datab => \udiv1hz|process_0~9_combout\,
	datac => \udiv1hz|process_0~0_combout\,
...
-- Equation(s):
-- \udiv1hz|process_0~11_combout\ = (\udiv1hz|process_0~8_combout\ & (!\udiv1hz|cpt1\(31) & (!\udiv1hz|cpt1\(30) & \udiv1hz|process_0~7_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \udiv1hz|process_0~8_combout\,
	datab => \udiv1hz|cpt1\(31),
	datac => \udiv1hz|cpt1\(30),
	datad => \udiv1hz|process_0~7_combout\,
...
-- Equation(s):
-- \udiv1hz|process_0~12_combout\ = (!\udiv1hz|state\(0) & (\udiv1hz|cpt1\(11) & (\udiv1hz|cpt1\(6) & !\udiv1hz|cpt1\(7))))
...
-- pragma translate_on
PORT MAP (
	dataa => \udiv1hz|state\(0),
	datab => \udiv1hz|cpt1\(11),
	datac => \udiv1hz|cpt1\(6),
	datad => \udiv1hz|cpt1\(7),
...
-- Equation(s):
-- \udiv1hz|process_0~14_combout\ = (!\udiv1hz|cpt1\(25) & (\udiv1hz|cpt1\(24) & (!\udiv1hz|cpt1\(23) & \udiv1hz|process_0~13_combout\)))
...
-- Equation(s):
-- \udiv1hz|clkout~0_combout\ = ((\udiv1hz|process_0~14_combout\ & (\udiv1hz|process_0~12_combout\ & \udiv1hz|process_0~11_combout\))) # (!\udiv1hz|process_0~10_combout\)
...
-- pragma translate_on
PORT MAP (
	dataa => \udiv1hz|process_0~14_combout\,
	datab => \udiv1hz|process_0~12_combout\,
	datac => \udiv1hz|process_0~11_combout\,
...
-- Equation(s):
-- \udiv1hz|cpt1~0_combout\ = (\udiv1hz|Add0~14_combout\ & \udiv1hz|process_0~10_combout\)
...
-- Equation(s):
-- \udiv1hz|cpt1~1_combout\ = (\udiv1hz|process_0~10_combout\ & \udiv1hz|Add0~30_combout\)
...
-- Equation(s):
-- \udiv1hz|cpt1~5_combout\ = (\udiv1hz|Add0~0_combout\ & \udiv1hz|process_0~10_combout\)
...
-- Equation(s):
-- \udiv1hz|cpt1~6_combout\ = (\udiv1hz|Add0~24_combout\ & \udiv1hz|process_0~10_combout\)
...
-- Equation(s):
-- \udiv1hz|cpt1~7_combout\ = (\udiv1hz|process_0~10_combout\ & \udiv1hz|Add0~26_combout\)
...
-- pragma translate_on
PORT MAP (
	datab => \udiv1hz|clkout~1_combout\,
...
-- Equation(s):
-- \ucompteurbp|state[1]~0_combout\ = (\ucompteurbp|state\(2)) # ((!\BP_Barbord~input_o\ & (\BP_Tribord~input_o\ & !\ucompteurbp|state\(1))))
...
-- Equation(s):
-- \ucompteurbp|Mux4~0_combout\ = (\BP_Tribord~input_o\ & (\ucompteurbp|state\(0) & \ucompteurbp|state\(1)))
...
-- pragma translate_on
PORT MAP (
	datab => \ucompteurbp|outCompteurBP_BP_STBY~q\,
	datad => \ucompteurbp|outCompteurBP_BP_Babord~q\,
...
-- Equation(s):
-- \usynchro|out_Synchro_led_Tribord~0_combout\ = (!\ucompteurbp|outCompteurBP_BP_Appuis~q\ & (\ucompteurbp|outCompteurBP_BP_Babord~q\ & !\ucompteurbp|outCompteurBP_BP_Tribord~q\))
...
PORT MAP (
	...
	datab => \ucompteurbp|outCompteurBP_BP_Babord~q\,
...
-- Equation(s):
-- \usynchro|out_Synchro_led_STBY~0_combout\ = (!\ucompteurbp|outCompteurBP_BP_Tribord~q\ & (\ucompteurbp|outCompteurBP_BP_STBY~q\ & (!\ucompteurbp|outCompteurBP_BP_Appuis~q\ & !\ucompteurbp|outCompteurBP_BP_Babord~q\)))
...
-- Equation(s):
-- \usynchro|comb~8_combout\ = (!\ucompteurbp|outCompteurBP_BP_Appuis~q\ & ((\ucompteurbp|outCompteurBP_BP_Tribord~q\) # ((\ucompteurbp|outCompteurBP_BP_STBY~q\) # (\ucompteurbp|outCompteurBP_BP_Babord~q\))))
...
-- Equation(s):
-- \usynchro|process_0~0_combout\ = (\ucompteurbp|outCompteurBP_BP_Appuis~q\ & \ucompteurbp|outCompteurBP_BP_Tribord~q\)
...
-- pragma translate_on
PORT MAP (
	dataa => \usynchro|comb~8_combout\,
	datac => \usynchro|process_0~0_combout\,
...
-- Equation(s):
-- \usynchro|comb~13_combout\ = (\ucompteurbp|outCompteurBP_BP_Tribord~q\ & (((\ucompteurbp|outCompteurBP_BP_Appuis~q\)))) # (!\ucompteurbp|outCompteurBP_BP_Tribord~q\ & (!\ucompteurbp|outCompteurBP_BP_Appuis~q\ & ((\ucompteurbp|outCompteurBP_BP_STBY~q\) # 
-- (\ucompteurbp|outCompteurBP_BP_Babord~q\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \usynchro|comb~9_combout\,
	datab => \usynchro|comb~13_combout\,
...
-- Equation(s):
-- \usynchro|comb~10_combout\ = (\ucompteurbp|outCompteurBP_BP_Tribord~q\) # ((\reset~input_o\ & ((\ucompteurbp|outCompteurBP_BP_Appuis~q\) # (\usynchro|comb~4_combout\))))
...
-- Equation(s):
-- \usynchro|comb~14_combout\ = (!\ucompteurbp|outCompteurBP_BP_Tribord~q\ & (!\ucompteurbp|outCompteurBP_BP_Appuis~q\ & ((\ucompteurbp|outCompteurBP_BP_STBY~q\) # (\ucompteurbp|outCompteurBP_BP_Babord~q\))))
...
-- Equation(s):
-- \usynchro|comb~12_combout\ = (\ucompteurbp|outCompteurBP_BP_Tribord~q\) # ((!\ucompteurbp|outCompteurBP_BP_Appuis~q\ & \ucompteurbp|outCompteurBP_BP_Babord~q\))
...
-- Equation(s):
-- \usynchro|out_Synchro_code_fonction\(2) = (!\usynchro|comb~11_combout\ & ((\usynchro|out_Synchro_code_fonction\(2)) # (\usynchro|comb~12_combout\)))
...
PORT MAP (
	...
	datad => \usynchro|comb~12_combout\,
